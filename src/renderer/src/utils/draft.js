/*
SELECT GROUP_CONCAT(card SEPARATOR ',') FROM (SELECT CAST(SUBSTRING(card, 1, LOCATE(' ', card) - 1) AS UNSIGNED) AS card, AVG(pick) AS avg_pick FROM `draft_picks` WHERE game = 'restart' AND `set` = 4 GROUP BY card ORDER BY 2 DESC) t1;
*/
...
export const motd_order = {
  ...
  "40": [72,23,104,55,126,163,218,36,204,93,144,166,101,203,32,137,180,108,177,57,215,143,69,139,27,171,103,35,141,19,24,168,214,92,140,211,100,107,29,56,105,102,220,34,129,165,44,132,67,169,190,22,206,21,60,213,61,86,175,25,33,179,173,114,161,142,51,167,212,46,83,196,31,14,20,85,96,84,199,17,37,109,13,26,217,209,133,9,45,65,82,99,16,157,127,115,80,146,188,136,71,8,113,78,66,170,10,123,194,28,135,30,63,198,130,205,210,87,79,186,191,192,62,208,42,153,120,172,160,88,81,89,2,116,187,124,7,15,6,148,118,52,11,131,149,77,162,159,48,158,134,182,119,68,97,156,5,38,195,145,49,18,150,76,183,91,112,95,216,39,125,174,207,1,178,54,74,90,64,75,164,73,70,50,43,176,59,202,41,151,106,128,184,193,155,40,152,200,117,110,197,98,185,94,147,58,12,201,4,53,138,3,189,154,111,181,121,219,47,122]
}
...
export const karapet_score = {
  ...
  "40": [0,8.8,6.9,4.3,5.8,6.3,0.0,4.1,8.5,5.9,8.6,4.7,6.3,7.0,4.1,6.2,4.6,5.5,5.8,7.9,8.7,10.0,7.5,4.4,10.5,10.3,10.3,8.8,6.7,6.3,8.1,8.0,6.6,4.6,4.7,5.1,4.9,0.0,0.0,7.1,8.4,6.2,7.2,5.3,2.8,7.9,4.5,0.0,3.4,7.1,6.2,9.0,7.3,6.5,5.3,7.8,9.0,0.0,6.2,7.5,7.6,6.1,6.9,7.5,5.3,8.1,6.9,8.5,5.2,14.5,3.0,5.3,8.6,6.2,5.7,0.0,9.0,0.0,5.7,6.0,6.8,7.6,8.1,11.2,7.7,8.2,5.9,5.3,5.9,5.7,7.5,4.1,9.0,5.7,0.0,10.4,9.1,6.2,5.0,5.3,8.8,6.3,8.1,6.6,11.2,7.9,7.0,6.3,6.4,0.0,8.0,6.0,7.0,7.2,5.4,7.0,6.4,3.2,7.6,7.1,5.9,6.1,4.9,6.6,7.1,7.4,10.2,7.2,5.8,4.3,5.8,5.1,3.6,0.0,8.1,9.5,11.6,8.6,7.7,7.1,6.3,8.4,7.6,7.1,9.9,8.2,6.9,6.0,0.0,5.5,7.3,4.2,5.5,7.2,0.0,5.5,2.9,5.2,5.7,7.4,7.2,9.2,5.5,13.8,6.4,3.9,5.9,7.8,8.8,6.7,8.7,6.8,8.8,6.1,4.2,7.8,5.2,8.2,6.3,3.9,5.7,0.0,5.6,0.0,5.0,6.4,4.8,8.7,6.0,3.9,4.5,6.9,6.4,4.7,6.1,7.8,8.6,6.0,7.7,2.1,5.4,5.4,6.2,9.1,8.8,6.5,7.9,7.6,11.4,8.5,3.4,3.8,10.4,4.2,5.5,6.2,6.4,6.2,8.0,5.7,7.2]
}
