...
export const karapet_score = {
  ...
  "50": [0,6.0,0.0,9.1,5.1,6.1,7.2,8.9,9.0,0.0,5.8,6.8,0.0,8.5,6.4,6.1,0.0,0.0,8.7,7.3,7.5,7.9,0.0,0.0,7.2,0.0,7.8,5.5,10.6,0.0,10.8,7.2,0.0,0.0,0.0,8.7,6.3,5.1,5.0,0.0,3.6,7.2,0.0,6.8,0.0,0.0,5.3,6.0,7.3,10.7,0.0,5.8,6.6,4.8,6.8,5.1,7.3,0.0,10.6,0.0,0.0,6.1,9.6,11.5,8.9,6.1,0.0,0.0,6.1,9.6,5.1,5.2,5.9,0.0,5.7,0.0,7.7,9.6,6.1,5.3,0.0,9.1,7.3,4.1,11.9,0.0,7.3,0.0,7.5,5.0,1.1,0.0,5.2,5.8,7.2,0.0,5.4,8.1,0.0,5.3,10.6,11.7,7.4,8.6,6.1,7.0,5.0,6.7,6.2,5.1,5.9,6.7,6.2,0.0,5.6,9.4,5.5,7.6,7.3,7.7,0.0,7.6,6.5,9.4,5.5,5.4,0.0,6.7,0.0,0.0,9.6,0.0,6.9,0.0,8.4,5.0,7.2,4.5,7.2,3.7,0.0,5.3,0.0,0.0,5.1,0.0,0.0,4.5,0.0,0.0,11.5,6.1,4.4,6.8,7.2,7.4,8.8,5.1,5.5,0.0,4.8,6.8,6.4,6.1,7.7,4.1,6.5,6.7,7.2,0.0,10.6,7.8,0.0,5.8,6.7,9.8,7.1,0.0,5.8,6.9,5.2,0.0,4.2,0.0,6.9,5.9,7.2,4.3,0.0,7.3,8.0,8.1,9.9,6.3,6.6,7.5,0.0,0.0,7.4,5.9,0.0,0.0,0.0,0.0,4.2,0.0,9.2,7.1,7.8,6.1,7.1,0.0,4.9,11.2,3.7,6.5,0.0,9.2,0.0,8.9,4.4]
}
...
function getBoosterV2(cardsByRarityAndColor) {
  ...
  const booster = [];
  booster.push(...((Math.random() < 4 / 24 && cardsByRarityAndColor[4][1].length > 0) ? selectRandomCardsFromDifferentColors(cardsByRarityAndColor[4], 1) : selectRandomCardsFromDifferentColors(cardsByRarityAndColor[3], 1)));
