  ...
  <article id="about">
      <div>
        ...
        <p>Всем, кто поддерживает разработку на <a href="https://boosty.to/berserk-nxt" target="_black" on:click={() => { click = true }}>Boosty</a>:<br />
            <b>Виктор Соколов</b>, <b>Ксения Ященко</b>, <b>Stan_I.</b>, <b>Павел Карпов</b>, <b>Геннадий Лебедев</b>, <b>Людмила Дубровская</b>, <b>Shchigel</b>, <b>Евгений Морозов</b>, <b>Ivan Kochelorov</b>, <b>SeaSaw</b>, <b>Михаил Руденко (и команда тестеров)</b>, <b>Павлик Панфутов</b>, <b>Ден Борис</b>, <b>Александр Швепс</b></p>
        ...
        <p style="margin-top: 2em"><i>Все права на игру и изображения в ней принадлежат ООО «Мир Хобби».</i></p>
      </div>
  </article>
</dialog>
{/if}
